 ...
 * <ul>
 *   <li>{@link ausim.xtext.kanban.domainmodel.kanbanmodel.NumExpression#getNumValue <em>Num Value</em>}</li>
 *   <li>{@link ausim.xtext.kanban.domainmodel.kanbanmodel.NumExpression#isDistribution <em>Distribution</em>}</li>
 *   <li>{@link ausim.xtext.kanban.domainmodel.kanbanmodel.NumExpression#getNumDist <em>Num Dist</em>}</li>
 * </ul>
 * </p>
 *
 * @see ausim.xtext.kanban.domainmodel.kanbanmodel.KanbanmodelPackage#getNumExpression()
 * @model
 * @generated
 */
public interface NumExpression extends EObject
{
   ...
   * @see ausim.xtext.kanban.domainmodel.kanbanmodel.KanbanmodelPackage#getNumExpression_NumValue()
   * @model
   * @generated
   */
  String getNumValue();
  ...
  /**
   * Sets the value of the '{@link ausim.xtext.kanban.domainmodel.kanbanmodel.NumExpression#getNumValue <em>Num Value</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see ausim.xtext.kanban.domainmodel.kanbanmodel.KanbanmodelPackage#getNumExpression_Distribution()
   * @model
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link ausim.xtext.kanban.domainmodel.kanbanmodel.NumExpression#isDistribution <em>Distribution</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see ausim.xtext.kanban.domainmodel.kanbanmodel.KanbanmodelPackage#getNumExpression_NumDist()
  ...
  /**
   * Sets the value of the '{@link ausim.xtext.kanban.domainmodel.kanbanmodel.NumExpression#getNumDist <em>Num Dist</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
